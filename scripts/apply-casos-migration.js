/**
 * Script para aplicar migration de casos individuais de dengue
 */
...
async function applyMigration() {
  ...
  try {
    console.log('\n' + '='.repeat(80));
    console.log('APLICANDO MIGRATION: ADD_VIGILANCIA_DENGUE_CASO');
    console.log('='.repeat(80));
    console.log();

    // Ler o arquivo SQL da migration
    const migrationPath = path.join(__dirname, '../packages/database/migrations/add_casos_individuais.sql');
    ...
    console.log('✓ Tabela vigilancia_dengue_caso criada');
    console.log('='.repeat(80));
    console.log();
